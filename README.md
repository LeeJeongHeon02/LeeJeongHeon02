...
<p align="center">
  Java와 Spring으로 안정적인 백엔드 시스템을 만들고,<br/>
  측정과 검증을 통해 성능을 개선하는 개발자 이정헌입니다.
</p>
...
- 🏆 **대상** — UMC 10th 데모데이, [Muffin](https://github.com/LeeJeongHeon02/muffin-back)
- 🏆 **최우수상** — TAVE 17th 후반기 컨퍼런스, [JobAI](https://github.com/LeeJeongHeon02/jobai-backend)
- 🏆 **혁신상** — 신한 스퀘어브릿지 청년 해커톤, [Loovi](https://github.com/LeeJeongHeon02/loovi-backend)

## Engineering Notes

| 주제 | 문제와 결과 |
| --- | --- |
| [이벤트 기반 비동기 처리로 이미지 업로드 API 성능 개선](https://velog.io/@aoc0523/%EC%84%B1%EB%8A%A5%EA%B0%9C%EC%84%A0-Spring-%EC%9D%B4%EB%B2%A4%ED%8A%B8-%EA%B8%B0%EB%B0%98-%EB%B9%84%EB%8F%99%EA%B8%B0-%EC%B2%98%EB%A6%AC%EB%A1%9C-%EC%9D%B4%EB%AF%B8%EC%A7%80-%EC%97%85%EB%A1%9C%EB%93%9CAPI-%EC%84%B1%EB%8A%A5-80-%EA%B0%9C%EC%84%A0%ED%95%98%EA%B8%B0) | 외부 S3 I/O와 DB 트랜잭션을 분리해 평균 응답시간 약 80% 단축 |
| [Spring Proxy와 Self-invocation 문제 해결](https://velog.io/@aoc0523/%ED%8A%B8%EB%9F%AC%EB%B8%94%EC%8A%88%ED%8C%85-%EC%A3%BD%EC%96%B4%EB%B2%84%EB%A6%B0-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98-%EC%82%B4%EB%A6%AC%EA%B8%B0-%ED%94%84%EB%A1%9D%EC%8B%9CProxy%EC%99%80-%EB%82%B4%EB%B6%80-%ED%98%B8%EC%B6%9CSelf-invocation-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0) | 내부 호출로 무시되던 `@Transactional`을 책임 분리와 별도 Bean 구성으로 해결 |

## Certifications

| 취득일 | 자격 | 발급기관 |
| --- | --- | --- |
| 2026.05.16 | **AWS Certified Solutions Architect – Associate** | Amazon Web Services |
| 2026.02.27 | **데이터분석 준전문가(ADsP)** | 한국데이터산업진흥원 |
| 2024.06.18 | **정보처리기능사** | 한국산업인력공단 |
...
<p align="center">
  <a href="https://velog.io/@aoc0523/posts">
    <img src="https://img.shields.io/badge/Tech_Blog-20C997?style=flat-square&logo=velog&logoColor=white" alt="Tech Blog" />
  </a>
  <a href="https://www.linkedin.com/in/%EC%A0%95%ED%97%8C-%EC%9D%B4-9620a0326/">
